...
class Html extends Plugin implements PluginInterface
{
    ...
    public function getPanel()
    {
        ...
        $panel .= $dom->getElementsByTagName('*')->length . ' Tags in ' . round(
                strlen($body) / 1024, 2
            ) . 'K' . $linebreak
            ...
            . '<form method="post" action="http://validator.w3.org/check"><p><input type="hidden" name="fragment" value="' . htmlentities(
                $body
